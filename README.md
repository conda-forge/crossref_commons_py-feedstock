About crossref_commons_py-feedstock
===================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/crossref_commons_py-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14128&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/crossref_commons_py-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `crossref_commons_py` can be installed with `conda`:
...
```
mamba install crossref_commons_py
```

It is possible to list all of the versions of `crossref_commons_py` available on your platform with `conda`:
...
```
mamba search crossref_commons_py --channel conda-forge
```
...
mamba repoquery search crossref_commons_py --channel conda-forge

# List packages depending on `crossref_commons_py`:
mamba repoquery whoneeds crossref_commons_py --channel conda-forge

# List dependencies of `crossref_commons_py`:
mamba repoquery depends crossref_commons_py --channel conda-forge
```
